...
Full human-readable spec: `docs/PROTOCOL.md`. Firmware (C++) mirrors this by hand in `firmware/display/include/domain/protocol.h` — the two must be kept in sync, and `docs/PROTOCOL.md` is the contract of record when they disagree.
