...
#pragma warning restore CA1031
        ...
        NavigationViewSelectionChangedEventArgs args)
    {
        ...
        bool built = tag is "radar" or "board" or "sources" or "settings" or "alerts"
            or "track" or "history" or "diagnostics";
        ...
        (string title, string detail) = tag switch
        {
            "areas" => ("Monitoring Areas",
                ...
                "bands today; the map-based editor is planned for Phase 2. A circle around your " +
                "home location is used in the meantime, set in Settings."),
            "devices" => ("Devices",
